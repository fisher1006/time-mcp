# Time MCP Server
[![smithery badge](https://smithery.ai/badge/@fisher1006/time-mcp)](https://smithery.ai/server/@fisher1006/time-mcp)
...
To install time-mcp for Claude Desktop automatically via [Smithery](https://smithery.ai/server/@fisher1006/time-mcp):

```bash
npx -y @smithery/cli install @fisher1006/time-mcp --client claude
```
